...
const char* fs_3d = "#version 140\n"
                    ...
                    "       vec3 sample_coord = vec3(TexCoord.xy, 1) * mat3(pixels_transform[0], pixels_transform[1], vec3(0, 0, 1));\n"
                    "       //vec3 sample_coord = vec3(TexCoord.xy, 1) * mat3(1, 0, tex_offs, 0, 1, 0, 0, 0, 1);\n"
