/*
 * Maps SDL3 scancodes to directinput keynums/scancodes.
...
// maps SDL3 scancodes to directinput keynums/scancodes - dinput_key = sdlScanCodeToDirectInputKeyNum[(int)your_sdl3_scancode];
