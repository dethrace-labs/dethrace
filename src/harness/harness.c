...
static int carmageddon_ascii_table[128] = {                                                            0,     /* KEY_SHIFT_ANY */
    0,     /* KEY_ALT_ANY */
    0,     /* KEY_CTRL_ANY */
    0,     /* KEY_CTRL_ANY_2 */
    0,     /* KEY_CAPSLOCK */
...
static int carmageddon_ascii_shift_table[128] = {
    0,     /* KEY_SHIFT_ANY */
    0,     /* KEY_ALT_ANY */
    0,     /* KEY_CTRL_ANY */
    0,     /* KEY_CTRL_ANY_2 */
...
static int splatpack_xmasdemo_ascii_shift_table[128] = {                                                            0,     /* KEY_SHIFT_ANY */
    0,     /* KEY_ALT_ANY */
    0,     /* KEY_CTRL_ANY */
    0,     /* KEY_CTRL_ANY_2 */
    0,     /* KEY_CAPSLOCK */
...
static void Harness_DetectGameMode(void) {
    ...
    case eGame_carmageddon:
        ...
        case eGameLocalization_german:
            ...
            break;
        default:
            harness_game_info.defines.ascii_table = carmageddon_ascii_table;
            harness_game_info.defines.ascii_shift_table = carmageddon_ascii_shift_table;
            break;
        }
        break;
