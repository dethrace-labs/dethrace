...
enum {
    ...
    ePlatform_cap_sdl3 = 0x4,
    ePlatform_cap_video_mask = ePlatform_cap_software | ePlatform_cap_opengl | ePlatform_cap_sdl3,
};
...
// or NULL when SDL3 is linked directly. Used by the sdl3gpurend BRender driver to
